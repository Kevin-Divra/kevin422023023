function getDataByWindowUrlKey() {
    ...
    let url = baseUrl+'/api/sport/'+windowUrlKey;
    ...
    .then(function (response) {
        ...
        $('#product-category').html('First published '+response.data.publication_year+' by '+response.data.category);
        ...
        // START -- note, unless you have these data in a database structure, here we are hardcoding them for display purposes
            ...
            // tag
            let collectionOfTag = ['Foot Ball','Futsal','Basket Ball','Volley Ball','Badminton','Running','Swimming','Billiard','Tenis Meja'];
    ...
    .catch(function (error) {
        console.log('[ERROR] response..', console.error.code);
